...
var catchreacterror = function catchreacterror() {
  ...
  return function (InnerComponent) {
    if (Boundary && !Boundary.prototype.isReactComponent) {
      console.warn("The ".concat(Boundary, " component is not a react component"));
    ...
    if (Boundary && !(Boundary.prototype.componentDidCatch || Boundary.prototype.getDerivedStateFromError)) {
      console.warn("".concat(Boundary, " doesn't has componentDidCatch or getDerivedStateFromError"));
      Boundary = _DefaultErrorBoundary["default"];
    } // 将React.memo包裹过的组件转换成普通函数式组件


    if (!(0, _index.isComponentClass)(InnerComponent) && (0, _index.isReactMemo)(InnerComponent)) {
